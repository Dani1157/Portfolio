// ============================================
// ULTIMATE SPACE DEFENDER - With Levels, Bosses & Upgrades!
// Features: 20+ levels, 5 boss fights, power-up system, achievements
// ============================================
...
(function() {
  ...
  const projects = [
    {
      title: 'TaskFlow',
      impact: 'Boosted team productivity by 45%',
      problem: 'Teams struggled with scattered task management',
      solution: 'Built a real-time collaborative board with drag-drop',
      result: '2,500+ tasks organized monthly',
    ...
    {
      title: 'WeatherWise',
      impact: 'Serving 10k+ daily active users',
      problem: 'Weather apps were cluttered and slow',
      solution: 'Minimalist PWA with smart caching',
      result: '95% faster load times',
      tech: ['JavaScript', 'OpenWeather API', 'Service Workers'],
      github: '#',
      live: '#'
    },
    {
      title: 'Java Quest',
      impact: 'Educational game used in 3 universities',
      problem: 'Students found OOP concepts boring',
      solution: 'Turn-based RPG teaching inheritance/polymorphism',
      result: '90% positive student feedback',
      tech: ['Java', 'Swing', 'OOP'],
      github: '#',
      live: '#'
    }
